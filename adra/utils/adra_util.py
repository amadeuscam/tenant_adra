        ...
        self.dict_alimentos.update(
            {
                ...
                f"2023Garbanzos cocidos_{index}": alimento.alimento_2,
                f"2023Conserva de atún_{index}": alimento.alimento_3,
                f"2023Conserva de carne_{index}": alimento.alimento_4,
                f"2023Pasta alimenticia espagueti_{index}": alimento.alimento_5,
                f"2023Pasta alimenticia fideo_{index}": alimento.alimento_6,
                f"2023Tomate frito en conserva_{index}": alimento.alimento_7,
                f"2023Galletas_{index}": alimento.alimento_8,
                f"2023Macedonia de verduras en conserva_{index}": alimento.alimento_9,
                f"2023Cacao soluble_{index}": alimento.alimento_10,
                f"2023Tarritos infantiles pollo_{index}": alimento.alimento_11,
                f"2023Tarritos infantiles fruta_{index}": alimento.alimento_12,
