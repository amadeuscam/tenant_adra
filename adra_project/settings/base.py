...
ALIMENTOS_METADATA = {
    ...
    "alimento_2": {"name": "Garbanzos cocidos"},
    "alimento_3": {"name": "Conserva de atún"},
    "alimento_4": {"name": "Conserva de carne"},
    "alimento_5": {"name": "Pasta alimenticia (espagueti)"},
    "alimento_6": {"name": "Pasta alimenticia (fideo)"},
    "alimento_7": {"name": "Tomate frito en conserva (APIS)"},
    "alimento_8": {"name": "Tomate frito en conserva (ACICO)"},
    "alimento_9": {"name": "Galletas"},
    "alimento_10": {"name": "Macedonia de verduras en conserva"},
    "alimento_11": {"name": "Cacao soluble"},
    "alimento_12": {"name": "Tarritos infantiles pollo"},
    "alimento_13": {"name": "Tarritos infantiles fruta"},
    "alimento_14": {"name": "Alubias cocidas"},
    "alimento_15": {"name": "Conserva de sardina"},
    "alimento_16": {"name": "Fruta en conserva"},
}
