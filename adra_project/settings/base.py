...
ALIMENTOS_METADATA = {
    ...
    "alimento_7": {"name": "Tomate frito en conserva"},
    "alimento_8": {"name": "Galletas"},
    "alimento_9": {"name": "Macedonia de verduras en conserva"},
    "alimento_10": {"name": "Cacao soluble"},
    "alimento_11": {"name": "Tarritos infantiles pollo"},
    "alimento_12": {"name": "Tarritos infantiles fruta"},
}
